    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            ...
            <div class="m-portlet">
                ...
                if($_POST){
                    if($_POST["baslikTxt"] <> "" ){
                        $sorgu2=$baglanti->prepare("INSERT INTO iletisimbilgileri (baslik, icerik, muhID) VALUES (:baslikTxt, :icerikTxt, :muhID)");
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <input type="text" class="form-control m-input" id="baslikTxt" name="baslikTxt" placeholder="İçerik">
                            </div>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <input type="text" class="form-control m-input" id="icerikTxt" name="icerikTxt" placeholder="İçerik Detay">
                            </div>
                        </div>
                        ...
                        <div class="m-form__actions m-form__actions">
                            <div class="row">
                                <div class="col-lg-9 ml-lg-auto">
                                    <input type="submit" class="btn btn-brand" value="Ekle">
                                </div>
                            </div>
                        </div>
                    </div>
