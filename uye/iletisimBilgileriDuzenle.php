...
$sorgu = $baglanti->prepare("SELECT baslik, icerik FROM iletisimbilgileri WHERE id =:isID AND muhID =:muhID ");
    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            ...
            <div class="m-portlet">
                ...
                if($_POST){
                    if($_POST["baslikTxt"] <> "" ){
                        $sorgu2=$baglanti->prepare("UPDATE iletisimbilgileri SET baslik=:baslikTxt, icerik=:icerikTxt WHERE id=:id and muhID =:muhID");
                        ...
                        if ($sonuc2) {
                            ...
                            <div class="alert alert-success alert-dismissible fade show" role="alert" style="margin: 20px 10px">
                                ...
                                <span id="uyari"></span>
                                <script>
                                    ysYonlendir("uyari", "./iletisimBilgileri", 5);
                                </script>
                            </div>
                            <?php
                        } else {
